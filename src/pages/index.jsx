  ...
  return (
    <Scaffolding>
      <IndexSection>
        ...
        <P>
          Local governments are required to respond to any FOI request for records.
        ...
        <P>
          <A href="#make-a-police-record-request">Select your state and we'll show you what to do</A>:
        </P>
      </IndexSection>

      <IndexSection>
        <H2 id="make-a-police-record-request">Request Records from Your Local PD</H2>
        <div>
